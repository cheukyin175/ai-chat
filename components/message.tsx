    ...
    <AnimatePresence>
      <motion.div
        ...
        className={cn("w-full mx-auto max-w-3xl px-4 group/message",
          {
            "mb-6": message.role !== 'assistant', // Only apply bottom margin to non-assistant messages
            "mb-0": message.role === 'assistant'
          }
        )}
      ...
      >
        ...
        >
          ...
          <div className={cn("flex flex-col w-full", {
            "gap-4": message.role !== 'assistant', // Keep normal gap for user messages
            "gap-0": message.role === 'assistant'  // Reduce gap for assistant messages
          })}>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        variant="ghost"
                        className="px-3 h-fit rounded-full text-muted-foreground opacity-0 group-hover/message:opacity-100"
                        onClick={() => {
                          setMode('edit');
                        }}
                      >
